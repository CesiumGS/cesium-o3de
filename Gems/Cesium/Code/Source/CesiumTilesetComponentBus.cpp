...
namespace Cesium
{
    void BehaviorContextTilesetBoundingVolumeHelper::Reflect(AZ::ReflectContext* context)
    {
        if (auto behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context))
        {
            ...
            behaviorContext->Class<TilesetBoundingVolume>("TilesetBoundingVolume")
                ...
                ->Property("type", BehaviorContextTilesetBoundingVolumeHelper::GetType, nullptr)
                ->Property("boundingSphere", BehaviorContextTilesetBoundingVolumeHelper::GetBoundingSphere, nullptr)
                ->Property("orientedBoundingBox", BehaviorContextTilesetBoundingVolumeHelper::GetOrientedBoundingBox, nullptr)
                ->Property("boundingRegion", BehaviorContextTilesetBoundingVolumeHelper::GetBoundingRegion, nullptr)
                ;
        }
    }

    int BehaviorContextTilesetBoundingVolumeHelper::GetType(TilesetBoundingVolume* source)
    {
        if (source->index() == 1)
        {
    ...
    BoundingSphere* BehaviorContextTilesetBoundingVolumeHelper::GetBoundingSphere(TilesetBoundingVolume* source)
    {
        if (source->index() == 1)
        {
    ...
    OrientedBoundingBox* BehaviorContextTilesetBoundingVolumeHelper::GetOrientedBoundingBox(TilesetBoundingVolume* source)
    {
        if (source->index() == 2)
        {
    ...
    BoundingRegion* BehaviorContextTilesetBoundingVolumeHelper::GetBoundingRegion(TilesetBoundingVolume* source)
    {
        if (source->index() == 3)
        {
